...
We will be generating a wildcard certificate so a DNS entry is not needed for the subdomain I want to use to point to Proton Mail Bridge since this will be an internal service only.

...
We will be generating a wildcard certificate so a DNS entry is not needed in Cloudflare for the subdomain and it will obscure anyone looking at the Let's Encrypt [Certificate Transparency (CT) Logs](https://letsencrypt.org/docs/ct-logs/).
